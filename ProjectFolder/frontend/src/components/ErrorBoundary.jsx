 ...
 * whiteboard down with it. The identifier is fixed ΓÇö but the *class* of failure
...
export class ErrorBoundary extends Component {
  ...
  componentDidCatch(error, info) {
    // Keep the full diagnostic in the console instead of swallowing it ΓÇö the
    ...
    return (
      <div className="error-boundary">
        ...
        <p className="error-boundary-hint">
          Your board is safe ΓÇö this only affected the on-screen interface, and
 ...
 * tree stay alive.
 *
 * `resetKey` should be the shape record. When the record changes ΓÇö the user
 * edits it, undo rolls it back, a collaborator repairs it ΓÇö the boundary clears
