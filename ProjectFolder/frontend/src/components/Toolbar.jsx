...
export default function Toolbar({ tool, setTool, onShape, onConnector, onUndo, onRedo, canUndo, canRedo, onDelete, hasSelection }) {
  ...
  return (
    <div className="toolbar">
      ...
      <ToolBtn id="eraser" label="Eraser (E)">
        {svg(<>
          <path d="M8 15 L3 10 L11 2 L17 8 L12 13 Z" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
          <path d="M8 15 H16" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
        </>)}
      </ToolBtn>
