 ...
 *
 * Yjs guarantees that everyone converges on the SAME document ΓÇö it does not
 ...
 *
 * Everything in this file is pure ΓÇö no React, no Konva, no document access ΓÇö
 ...
 * Non-finite entries are dropped in PAIRS so x/y never desynchronise ΓÇö a
 ...
 * id ΓÇö React needs a key and a duplicate/undefined key is its own class of
 * rendering bug.
 */
