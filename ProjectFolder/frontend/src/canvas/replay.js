 ...
 *
 * Kept deliberately free of React and Konva ΓÇö it imports nothing but Yjs ΓÇö so
 ...
 * yields exactly the document as it stood after update n ΓÇö not a guess at it.
 *
 ...
 * Playback ΓÇö the case that has to be smooth ΓÇö becomes O(1) amortised per frame,
